...
const PLAYABLE_WATER_FEATURE_NAMES = new Set([
  ...
  "Chesapeake Bay", "Massachusetts Bay", "Bay of Campeche", "Bo Hai",
...
const GULFS_BAYS_50M: PhysicalFeature[] = [
  ...
  { name: "Bay of Campeche",   type: "gulf", difficulty: "hard",   shape: { kind: "ellipse", center: [-93.3, 19.1],  rx: 3, ry: 3,  rotation: 0 }},
